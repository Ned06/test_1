...
$Personnel = "SELECT refUti, nomUti, pnomUti, mailUti, contUti, adressUti, motpassUti, descripTypeUti, statutUti, descripServices FROM utilisateur , type_utilisateur, services WHERE utilisateur.codeTypeUti = type_utilisateur.codeTypeUti AND utilisateur.refServices = services.refServices";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
            <h1 class="animated rotateInUpLeft text-primary">LISTE DU PERSONNEL</h1>
        ...
        <div class="row">
            ...
            <tbody>
              <?php foreach($Personnel as $data){ ?>
              <tr>
                <td><?php echo $data->nomUti; ?></td>
                <td><?php echo $data->pnomUti; ?></td>
                <td><?php echo $data->mailUti; ?></td>
                <td><?php echo $data->adressUti; ?></td>
                <td><?php echo $data->contUti; ?></td>
                <td><?php echo $data->descripTypeUti; ?></td>
                <td><?php echo $data->descripServices; ?></td>
                <td><a href="presence.php?employer=<?php echo $data->refUti?>"><button  type="button" name="presence" class="btn btn-primary">Présences</button></a></td>
