...
$tache = "SELECT idTache, utilisateur.refUti, utilisateur.nomUti, utilisateur.pnomUti, dateTache, descripTache, detailTache, natureTache FROM taches , utilisateur WHERE utilisateur.refUti = taches.refUti ";
$tache = $pdo->query($tache);
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="text-right">
            <a class="btn btn-primary btn-md" href="tache.php"><i> Affecter une tâche</i></a>
            <a class="btn btn-primary btn-md" href="listePers.php"><i> Liste de personnel</i></a>
          </div>
        ...
        <div class="container-fluid">
            <h1 class="animated rotateInUpLeft text-primary">LISTE DES TÂCHES</h1>
        ...
        <div class="row">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo $data->detailTache; ?></td>
                <td><?php echo $data->natureTache; ?></td>
                <td>
                  <a class="btn btn-warning btn-block"  href="voirTache.php?tach=<?= $data->idTache;?>">VOIR</a>
                </td>
          ...
          <a href="impression_taches.php?"><button  type="button" name="presence" class="btn btn-danger btn-lg">Impression</button></a>
        </div>
      </div>
    </div>
  </div>
