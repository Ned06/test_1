...
if(isset($_GET["employer"]))
{
    ...
    $emp = "SELECT refUti,nomUti, pnomUti FROM utilisateur WHERE utilisateur.refUti = :employer";
    $emp = $pdo->prepare($emp);
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
            <h1 class="animated rotateInUpLeft text-primary">LISTE DE PRESENCE</h1>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-dark">NOM et PRENOM : <?php echo $emp->nomUti; ?>  <?php echo $emp->pnomUti; ?></h6>
            </div>
            <div class="card-body">
        <div class="row">
            <div class="col-sm-12">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo $data->jourPresence; ?></td>
                <td><?php echo $data->heureArriveePresence; ?></td>
                <td><?php echo $data->heureDepartPresence; ?></td>
          ...
          <?php  ?>
          <a href="impression_presences.php?employer=<?php echo $emp->refUti?>"><button  type="button" name="presence" class="btn btn-danger btn-lg">Impression</button></a>
        </div>
      </div>
    </div>
  </div>
