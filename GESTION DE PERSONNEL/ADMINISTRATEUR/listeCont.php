...
$contrat = "SELECT utilisateur.refUti, type_contrat.reftypCont, refCont, descripCont, datedebutCont, datefinCont, nomUti, pnomUti, descriptypCont FROM contrat , type_contrat, utilisateur WHERE utilisateur.refUti = contrat.refUti AND type_contrat.reftypCont = contrat.reftypCont ";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="text-right">
            ...
            <a class="btn btn-primary btn-md" href="presence.php"><i> Voir les Présences</i></a>
          </div>
        ...
        <div class="container-fluid">
            <h1 class="animated rotateInUpLeft text-primary">LISTE DES CONTRATS</h1>
        ...
        <div class="row">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo $data->descriptypCont; ?></td>
                <td><?php echo $data->datedebutCont; ?></td>
                <td><?php echo $data->datefinCont; ?></td>
                <td><?php echo $data->descripCont; ?></td>
                <td>
                    <a href="modifCont.php?employer=<?php echo $data->refUti?>"><button type="button" name="Edit" class="btn btn-success">Modifier</button></a>
                    <a href="deletCont.php?employer=<?php echo $data->refUti?>"><button type="button" name="Delete" class="btn btn-danger">Supprimer</button></a>
                </td>
          ...
          <a href="impression_contrat.php?"><button  type="button" name="presence" class="btn btn-danger btn-lg">Impression</button></a>
        </div>
      </div>
    </div>
  </div>
